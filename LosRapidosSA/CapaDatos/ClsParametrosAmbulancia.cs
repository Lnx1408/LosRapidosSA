...
namespace CapaDatos
{
    public class ClsParametrosAmbulancia
    {
        ...
        public ClsParametrosAmbulancia(String modelo, String tipoAmbulancia, String placa, String matricula, String fechaActivacion, String estado, String observacion)
        {
            this.modelo = modelo;
